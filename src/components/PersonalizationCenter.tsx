    ...
    <div className="space-y-8">
      <AnimatePresence>
        {showCamera && (
          ...
          >
            <div className="w-full max-w-3xl aspect-square bg-white/5 rounded-[3rem] overflow-hidden relative border border-white/10">
            ...
            <div className="flex gap-6 mt-12">
              ...
              <button 
                ...
                className="w-20 h-20 rounded-full bg-nothing-yellow flex items-center justify-center text-black shadow-2xl shadow-nothing-yellow/40 hover:scale-110 transition-transform"
              >
                <Camera size={32} />
              </button>
            </div>
            <DotMatrixText color="text-nothing-yellow" className="mt-8">CAPTURE_IDENTITY_FRAME</DotMatrixText>
          </motion.div>
        )}
      </AnimatePresence>
      ...
      <div>
        ...
        <div className="space-y-4">
          ...
          <div className="bg-white/5 rounded-[2rem] p-6 border border-white/5 flex items-start gap-4">
            <User size={20} className="text-nothing-yellow mt-1" />
            <div className="flex-1">
          ...
          <div className="bg-white/5 rounded-[2rem] p-6 border border-white/5 flex items-start gap-4">
            <Tag size={20} className="text-nothing-yellow mt-1" />
            <div className="flex-1">
          ...
          <div className="bg-white/5 rounded-[2rem] p-6 border border-white/5 flex items-start gap-4">
            <MessageSquare size={20} className="text-nothing-yellow mt-1" />
            <div className="flex-1">
          ...
          <div className="bg-white/5 rounded-[2rem] p-6 border border-white/5 flex items-start gap-4">
            <Briefcase size={20} className="text-nothing-yellow mt-1" />
            <div className="flex-1">
          ...
          <div className="bg-white/5 rounded-[2rem] p-6 border border-white/5 flex items-start gap-4">
            <Globe size={20} className="text-nothing-yellow mt-1" />
            <div className="flex-1">
              ...
              <div className="space-y-2 mt-2">
                <input 
                  ...
                  className="w-full bg-white/5 rounded-full px-4 py-2 text-white text-xs font-mono outline-none border border-white/5 focus:border-nothing-yellow"
                />
                <input 
                  type="text" 
      ...
      <div>
        ...
        <div className="space-y-4">
          <div className="bg-white/5 rounded-[2rem] p-6 border border-white/5 flex items-center gap-4">
            <MapPin size={20} className="text-nothing-yellow" />
            <div className="flex-1">
          ...
          <div className="bg-white/5 rounded-[2rem] p-6 border border-white/5 flex items-center gap-4">
            <Music size={20} className="text-nothing-yellow" />
            <div className="flex-1">
          ...
          {modes.map(mode => (
            <button
              ...
              className={cn(
                ...
                state.mode === mode ? "bg-nothing-yellow border-nothing-yellow" : "bg-white/5 border-white/5 hover:bg-white/10"
              )}
            >
      ...
      <button 
        ...
        className="w-full py-6 bg-nothing-yellow rounded-full text-[10px] font-mono uppercase tracking-widest text-black font-bold shadow-lg shadow-nothing-yellow/20"
      >
